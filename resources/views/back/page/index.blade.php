...
@section('content')
    <div class="row g-0">
        <div class="col-md-12 mb-3">
            <h1 class="text-center">Daftar Page</h1>
        </div>
        <div class="d-flex justify-content-between">
            <div class="col-3 col-md-3 mb-3">
                <a href="{{ route('posts.create') }}" class="btn btn-primary">Tambah Page</a>
            </div>
                        ...
                        @foreach ($data as $key => $value)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('posts.edit', ['post' => $value->id]) }}"
                                        class="btn btn-warning">Edit</a>
                                    <a href="{{ route('posts.delete', ['post' => $value->id]) }}"
